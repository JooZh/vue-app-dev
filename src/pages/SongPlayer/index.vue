<template>
    <div id="song-player">
        <div v-show="playerState" class="player">
            ...
            <div class="play-center">
                <div
                    class="circle"
                    :class="{ toggleShow: playLyricShow, toggleHide: !playLyricShow }"
                    @click="toggleLyric"
                >
                    <img
                        class="cd"
                        :class="{ paused: !playStatus }"
                        :src="playSongImage"
                        :onerror="defaultImg"
                    />
                </div>
                <div
                    ...
                    class="lyric"
                    :class="{
                        center: playLyric.length === 1,
                        toggleShow: !playLyricShow,
                        toggleHide: playLyricShow
                    }"
                    @click="toggleLyric"
                >
            ...
            <div class="play-bottom">
                ...
                <div class="play-buttons">
                    ...
                    <div class="button">
                        <div class="cltr">
                            <div v-show="!playStatus" class="play" @click="handlePlay">
                                <Icon type="md-play" />
                            </div>
                            <div v-show="playStatus" class="pause" @click="handlePause">
                                <Icon type="md-pause" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="play-list" :class="{ 'list-show': openList }">
                ...
                <div class="play-list-container">
                    <div class="play-list-nav border-half-bottom">
                        ...
                        <div class="nav-clear" @click="clearPlayerList">
                            <Icon class="icon" type="md-trash" /> 清空
                        </div>
                    </div>
...
export default {
    ...
    computed: {
        ...mapGetters(['playerState', 'playSong', 'playStatus', 'playerList'])
    },
    watch: {
        // 监听当前播放的歌曲
        playSong(song) {
    ...
    methods: {
        ...
        onTimeUpdate() {
            ...
            if (this.audio.buffered.length !== 0 && this.bufferPercent !== 1) {
                let bufferPercent = (
                    this.audio.buffered.end(0) / this.playSongLong
                ).toFixed(0);
